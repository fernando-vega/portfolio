...
export class HeroComponent implements OnInit {
  ...
  ngOnInit() {
    if (this.router.url === '/about') {
      this.backgroundImage = '../../../../portfolio/assets/images/hero/hero-1.png';
    } else if (this.router.url === '/portfolio') {
      this.backgroundImage = '../../../../portfolio/assets/images/hero/hero-2.png';
    } else if (this.router.url === '/resume') {
      this.backgroundImage = '../../../../portfolio/assets/images/hero/hero-3.png';
    }
    this.particles();
  }
  ...
  particles() {
    ...
    const ParticleNetwork = function(canvas, options) {
      ...
      this.options = {
        ...
        background: (options.background !== undefined) ? options.background : this.backgroundImage ,
    ...
    ParticleNetwork.prototype.setVelocity = (speed) => {
      if (speed === 'fast') {
        return 1;
      } else if (speed === 'slow') {
        return 0.33;
    ...
    ParticleNetwork.prototype.setDensity = (density) => {
      if (density === 'high') {
        return 8000;
      } else if (density === 'low') {
        return 20000;
    ...
    ParticleNetwork.prototype.setStyles = (div, styles) => {
    ...
    const canvasDiv = document.getElementById('hero');
    const options = {
      particleColor: '#fff',
